...
file_path = 'C:/Users/gcbjut/Desktop/lottery/AWR_Report_Parse/ttdb21_awr'
...
for i in range(len(table_result)):
    AAS.append(float(table_result[i][1]["Snap Time"]["DB Time:"].split("(mins)")[0]) / float(
        table_result[i][1]["Snap Time"]["Elapsed:"].split("(mins)")[0]))
...
bk = xlsxwriter.Workbook("C:/users/gcbjut/desktop/awr_values.xlsx")
